...
namespace Net.FreeORM.ZZZ_TestAppWFA.Source.Helper
{
    //====================================================================
    ...
    public class DatabaseHelper : IDisposable
    {
        ...
        public DatabaseHelper(string connectionstring, Providers provider)
        {
            ...
            switch (provider)
            {
                ...
                case Providers.ConfigDefined:
                    string providername = System.Configuration.ConfigurationManager.ConnectionStrings["connectionstring"].ProviderName;
        ...
        public DataSet ExecuteDataSet(string query, CommandType commandtype, ConnectionState connectionstate)
        {
            ...
            DbConnection dbCon = DbProviderFactories.GetFactory("System.Data.SqlClient").CreateConnection();
